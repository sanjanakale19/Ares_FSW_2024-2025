 ...
 * @file MS.h
 *
 * TE Connectivity MS5607 High-Resolution Barometric Altimeter. 
 *
 * Written for SPI.
 *
...
#include "HAL.h"
#include "Libraries/MS5607/MS5611_SPI2.h"

namespace MS {
    
    // RP_MS5607 ms;
    MS5611_SPI ms5607(HAL::ALT2_MS5607_CS, HAL::VSPI_bus);
    ...
    void setupMS() {
        ...
        // ms5607.begin();
        ms5607.setSPIport(HAL::VSPI_bus);
